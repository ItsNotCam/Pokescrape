...
if len(sys.argv) > 1 and sys.argv[1] == "true":
	...
	for idx, pokemon in enumerate(pokedex_table):
		...
		elements = get_tag_all(elements, "a")
...
print(tabulate(rows, headers=['#', 'Name', 'Elements'], tablefmt='pretty', stralign='left'))

# for row in rows:
# 	num, name, elements = row
# 	print(num, "\t", name, " ", elements)
